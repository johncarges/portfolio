...
const bioCopy = `
    ...
    <br>
    At NYU I developed passion not only for math and philosophy, but also for teaching. Of course, teaching is entirely about communication: how do I take the complex idea in my head and package it in a way that the student or group in front of me will be able to receive? I worked part-time as a teaching assistant at a Manhattan public school for the four years that I was at NYU, and also as a math tutor at the NYU tutoring center during my Junior and Senior years. Pursuing teaching after graduation, I worked with the math department at the NYU campus in Abu Dhabi to help students in smaller lecture groups and collaborate with other STEM departments to create more integrated curricula and resources.
    <br>
    ...
    <br>
    Perhaps it's not hard to see why I've enjoyed writing code ever since I began using Python and Mathematica at NYU. Or why, when film production was paused at the beginning of the Covid-19 quarantine, I immediately picked up Python again and began exploring the idea of working in software development. 
`